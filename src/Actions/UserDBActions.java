...
public class UserDBActions {
    ...
    public String[] getAllTasksByDeadLine(String userID, String deadLine) {
        Connection connection = dbConnect.openConnection();
        if (connection != null) {
        try {
        String query = QueryBuilder.getAllTasksByDeadLine(userID, deadLine);
        ...
        ticketTasks.toArray(new String[0]);
