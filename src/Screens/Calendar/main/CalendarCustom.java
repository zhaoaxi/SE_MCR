...
import javax.swing.*;
import Screens.Calendar.swing.PanelSlide;
...
public class CalendarCustom extends javax.swing.JPanel {
    ...
    public CalendarCustom() {
        initComponents();
        thisMonth();
        slide.show(new PanelDate(month, year, this), PanelSlide.AnimateType.TO_RIGHT);
        showMonthYear();
    ...
    private void initComponents() {
        ...
        slide = new Screens.Calendar.swing.PanelSlide();
        ...
        cmdBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Screens/Calendar/icon/back.png"))); // NOI18N
        ...
        cmdNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Screens/Calendar/icon/next.png"))); // NOI18N
    ...
    private void cmdNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNextActionPerformed
        ...
        slide.show(new PanelDate(month, year, this), PanelSlide.AnimateType.TO_LEFT);
        showMonthYear();
    ...
    public void setListData(Date date) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        String dateString = dateFormat.format(date);
        String[] newData = {dateString};
        jList1.setListData(newData);
    }
    
    public void modifyJListContent(String[] taskList) {
    ...
    private Screens.Calendar.swing.PanelSlide slide;
