...
import Screens.Calendar.main.Main;
...
public class MainScreen extends javax.swing.JFrame {
    ...
    public MainScreen() {
        ...
        topBarRight.setPreferredSize(new Dimension(330, 26));
        ...
        buttonGroupPanel.setBackground(Colors.primaryBlack);
        buttonGroupPanel.setLayout(new FlowLayout(FlowLayout.TRAILING, 0, 0));

        JPanel blankBoxBtnContent = new JPanel();
        blankBoxBtnContent.setPreferredSize(new Dimension(70, 14));
        blankBoxBtnContent.setBackground(Colors.transparent);
        blankBoxBtnContent.setLayout(null);
        JLabel blankBoxBtnIcon = FAicon("\uf073", 12, Colors.secondaryBlue);
        blankBoxBtnIcon.setBounds(50, 0, 18, 14);
        JLabel blankBoxBtnText = RegularText("Calendar", 12, Colors.secondaryBlue);
        blankBoxBtnText.setBounds(0, 0, 55, 14);
        blankBoxBtnContent.add(blankBoxBtnText);
        blankBoxBtnContent.add(blankBoxBtnIcon);
        RoundBtn blankBoxBtn = new RoundBtn(blankBoxBtnContent, Colors.secondaryBlack, Colors.neutralBlue, 25, 90, 25);
        blankBoxBtn.setBounds(0, 0, 90, 25);
        blankBoxBtn.addActionListener(e -> {
            calendar.setVisible(true);
            //this.dispose();
        });

        buttonGroupPanel.add(blankBoxBtn);
        buttonGroupPanel.add(accBtn);
        buttonGroupPanel.add(logoutBtn);

        topBarRight.add(buttonGroupPanel);
        ...
        if (userAuthority == 1){
            newProjBtn.setEnabled(false);
            newProjBtn.setVisible(false);
        }
...
//                        ((JLabel) searchBtn.getComponent(0)).setText("Reset Search");
    ...
    private void loadAuthority(){
        UserDBActions userDBActions = new UserDBActions();
        userAuthority = userDBActions.getUserRole(loggedUser);
    }
