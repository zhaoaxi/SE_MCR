...
public class QueryBuilder {
    ...
    public static String getAllTasksByDeadLine(String userID, String deadLine){
        return "SELECT ticketTask FROM tickets t JOIN project_tickets pt ON t.ticketID = pt.ticketID JOIN projects p " +
        "ON pt.projectID = p.projectID JOIN project_users pu ON p.projectID = pu.projectID WHERE t.deadLine='"+deadLine+"' AND pu.userID='"+userID+"';";
    }
